...
Function run(g.game)
	...
	testc.cell = fetchCellById(3)
	
	While testc\p\m <> Null
		testm.movelist = testc\p\m
		...
		testimg = LoadImage("cellGreen.png")
	...
	While testc\p\m\bef <> Null
		testc\p\m = testc\p\m\bef
	Wend
...
Function possibleCells.celloplayer(c.cell, moves.movelist, ramifying)
	...
	While dests\bef <> Null ;rewind cell list
		dests = dests\bef
	Wend
